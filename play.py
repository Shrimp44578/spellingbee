...
while running:
    ...
    draw_hexagon_buttons(game_letters, center_letter, SCREEN_WIDTH // 2, SCREEN_HEIGHT // 2, 50, LIGHT_BLUE if not dark_mode else DARK_GREY, BLACK if not dark_mode else WHITE)
    ...
    # Render used words
    used_words_text = FONT.render(f"Used Words: {', '.join(used_words)}", True, text_color)
    screen.blit(used_words_text, (20, 180))
    ...
    draw_button("Dark Mode", 700, 20, 120, 40, DARK_GREY, WHITE)
